...
import com.kursatmemis.navigationdrawer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // NavigationView ve NavHostFragment'ın birbirlerine göre çalışmasını sağlar.
        val navHostFragment =
    ...
    private fun setToggle() {
        binding.toolbar.title = "My -Toolbar - Title"
        val toggle =
            ActionBarDrawerToggle(this@MainActivity, binding.drawer, binding.toolbar, 0, 0)
    ...
    private fun setNavTittle() {
        binding.navigationView.inflateHeaderView(R.layout.nav_title)
